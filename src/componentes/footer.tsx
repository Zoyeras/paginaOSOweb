      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4">
              Creación de diseños personalizados para camisetas y accesorios.
            </p>
              ...
              <ul className="mt-4 space-y-3">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.url}
                      className={`text-base transition-all duration-200 relative group ${
                        darkMode
                          ? "text-gray-400 hover:text-gray-300"
        ...
        >
          ...
          >
            &copy; {currentYear} Pagina desarrollada por{" "}
            <a
            ...
            &{" "}
            <a href="https://aurea-web.com/Index" target="_blank">
              Auera web
            </a>{" "}
